    ...
    <v-container>
      <v-row class="center">
        <v-col cols="12" sm="12" md="4" lg="4">
          <v-btn to="/select/categories" x-large color="light-blue accent-1" block class="black--text"><b>材料から選ぶ</b></v-btn>
        </v-col>
        <v-col cols="12" sm="12" md="4" lg="4">
        ...
        >
          <v-item>
            <v-list-item-group>
              <v-list-item to="/">
                <v-list-item-icon>
                  <v-icon v-text="post.id"></v-icon>
                </v-list-item-icon>
                <v-list-item-content>
                  <v-img src="https://image.space.rakuten.co.jp/d/strg/ctrl/3/aedd5fa798b463b0371dceb8e3d0f529e4dc1b48.79.2.3.2.jpg?thum=55" aspect-ratio="1.7" contain></v-img>
